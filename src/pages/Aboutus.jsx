      ...
      <Container disableGutters>
        <Grid container spacing={8} sx={{ mb: sizes.base }}>
          ...
          <Grid item md={6} sm={12}>
            ...
            <Typography fontSize={18} fontFamily="muli-light" color="#252525" mt={3}>LIMELIFE is your bridge to the NFT world. We walk our clients through every step of the way. From design to launch, helping individuals and companies connect with their fan/customer base through NFTs.</Typography>
          </Grid>
        </Grid>
